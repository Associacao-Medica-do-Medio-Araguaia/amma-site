    ...
    <div className="flex-1">
      <div className="bg-linear-to-b from-accent-soft to-background">
        <div className="mx-auto max-w-7xl px-6 py-11 md:py-[46px]">
          ...
          <p className="mt-4 max-w-[580px] text-[15px] md:text-[16.5px] leading-relaxed text-muted-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-11 md:py-[52px]">
        ...
        <div className="mt-[26px] flex items-center gap-3.5 rounded-2xl border border-border/40 bg-surface px-5 py-4">
          <span className="shrink-0 flex h-[34px] w-[34px] items-center justify-center rounded-full bg-accent-soft text-secondary text-[17px] font-bold">
            ⤢
          </span>
